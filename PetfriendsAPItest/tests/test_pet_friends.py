...
def test_successful_update_self_pet_info(name='Мурзик', animal_type='Котэ', age=5):
    ...
    if len(my_pets['pets']) > 0:
        ...
        # с этого момента мои тесты


def test_new_pet_without_photo(name='Барбос', animal_type='двортер', age='3'):
...
def test_successful_add_pet_photo(pet_photo='images/cat1.jpg'):
    ...
    # почему-то выдает код 503, так и не разобрался
...
def test_delete_all_pets():
    ...
    # Проверяем - если список своих питомцев не пустой, то удаляем первого и запрпшвпем новый список
...
def test_change_name_second_pets(name="Мурзик", animal_type="cat", age="2" ):
    """Проверяем возможность обновления информации о питомце"""
    ...
    #изменяем имя второго питомца в списке
